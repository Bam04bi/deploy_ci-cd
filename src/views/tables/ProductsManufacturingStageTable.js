...
// ** Icons Imports
import ChevronUp from 'mdi-material-ui/ChevronUp'; // Importing the ChevronUp icon from the mdi-material-ui library
import ChevronDown from 'mdi-material-ui/ChevronDown'; // Importing the ChevronDown icon from the mdi-material-ui library

// Function to create data for the table
const createData = (name, calories, fat, carbs, protein, price) => {
  // Returning an object with specified properties and a history array
  return {
    name,
    calories,
    fat,
